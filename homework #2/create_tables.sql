...
CREATE TABLE Documents(
    id          INT     NOT NULL,
    type        VARCHAR NOT NULL  CHECK (type in ('passport', 'driver license')),
...
CREATE TABLE Orders(
    ...
    comment     TEXT    NULL,
    status      VARCHAR NOT NULL  DEFAULT 'in queue' CHECK (status IN('in queue', 'in progress', 'done', 'canceled')),
